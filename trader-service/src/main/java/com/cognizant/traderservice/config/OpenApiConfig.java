package com.cognizant.traderservice.config;
    ...
    public OpenAPI openAPI() {
        return new OpenAPI()
            .components(new Components()
                .addSecuritySchemes("keycloakAdmin", oauthScheme("admin", "Admin access"))
                .addSecuritySchemes("keycloakTrader", oauthScheme("trader", "Trader access"))
            )
